import { GeoIdByPlaceIdParams } from '../interfaces/params/GetInformationAboutAPlaceParams';
...
declare class GeoClient {
     ...
     * @param parameters
     */
    geoIdByPlaceId(parameters: GeoIdByPlaceIdParams): Promise<GeoIdByPlaceId>;
    /**
     ...
     */
    geoReverseGeocode(): Promise<GeoReverseGeocode>;
    /**
