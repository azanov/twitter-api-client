import { CollectionsEntriesParams, CollectionsListParams, CollectionsShowParams, CollectionsCreateParams, CollectionsDestroyParams, CollectionsEntriesAddParams, CollectionsEntriesMoveParams, CollectionsEntriesRemoveParams, CollectionsUpdateParams } from '../interfaces/params/CurateACollectionOfTweetsParams';
import { StatusesHomeTimelineParams, StatusesMentionsTimelineParams, StatusesUserTimelineParams } from '../interfaces/params/GetTweetTimelinesParams';
import { FavoritesListParams, StatusesLookupParams, StatusesRetweetsByIdParams, StatusesRetweetsOfMeParams, StatusesShowByIdParams, FavoritesCreateParams, FavoritesDestroyParams, StatusesDestroyByIdParams, StatusesRetweetByIdParams, StatusesUnretweetByIdParams } from '../interfaces/params/PostRetrieveAndEngageWithTweetsParams';
...
declare class TweetsClient {
     ...
     * @param parameters
     */
    collectionsEntries(parameters: CollectionsEntriesParams): Promise<CollectionsEntries>;
    /**
     ...
     * @param parameters
     */
    collectionsList(parameters: CollectionsListParams): Promise<CollectionsList>;
    /**
     ...
     * @param parameters
     */
    collectionsShow(parameters: CollectionsShowParams): Promise<CollectionsShow>;
    /**
     ...
     * @param parameters
     */
    collectionsCreate(parameters: CollectionsCreateParams): Promise<CollectionsCreate>;
    /**
     ...
     * @param parameters
     */
    collectionsDestroy(parameters: CollectionsDestroyParams): Promise<CollectionsDestroy>;
    /**
     ...
     * @param parameters
     */
    collectionsEntriesAdd(parameters: CollectionsEntriesAddParams): Promise<unknown>;
    /**
     ...
     */
    collectionsEntriesCurate(): Promise<unknown>;
    /**
     ...
     * @param parameters
     */
    collectionsEntriesMove(parameters: CollectionsEntriesMoveParams): Promise<unknown>;
    /**
     ...
     * @param parameters
     */
    collectionsEntriesRemove(parameters: CollectionsEntriesRemoveParams): Promise<unknown>;
    /**
     ...
     * @param parameters
     */
    collectionsUpdate(parameters: CollectionsUpdateParams): Promise<CollectionsUpdate>;
    /**
     ...
     * @param parameters
     */
    statusesHomeTimeline(parameters?: StatusesHomeTimelineParams): Promise<StatusesHomeTimeline>;
    /**
     ...
     * @param parameters
     */
    statusesMentionsTimeline(parameters?: StatusesMentionsTimelineParams): Promise<StatusesMentionsTimeline[]>;
    /**
     ...
     * @param parameters
     */
    statusesUserTimeline(parameters?: StatusesUserTimelineParams): Promise<StatusesUserTimeline[]>;
    /**
     ...
     * @param parameters
     */
    favoritesList(parameters?: FavoritesListParams): Promise<FavoritesList[]>;
    /**
     ...
     * @param parameters
     */
    statusesLookup(parameters: StatusesLookupParams): Promise<StatusesLookup[]>;
    /**
     ...
     */
    statusesRetweetersIds(): Promise<StatusesRetweetersIds>;
    /**
     ...
     * @param parameters
     */
    statusesRetweetsById(parameters: StatusesRetweetsByIdParams): Promise<StatusesRetweetsById[]>;
    /**
     ...
     * @param parameters
     */
    statusesRetweetsOfMe(parameters?: StatusesRetweetsOfMeParams): Promise<StatusesRetweetsOfMe[]>;
    /**
     ...
     * @param parameters
     */
    statusesShowById(parameters: StatusesShowByIdParams): Promise<StatusesShowById>;
    /**
     ...
     * @param parameters
     */
    favoritesCreate(parameters: FavoritesCreateParams): Promise<FavoritesCreate>;
    /**
     ...
     * @param parameters
     */
    favoritesDestroy(parameters: FavoritesDestroyParams): Promise<FavoritesDestroy>;
    /**
     ...
     * @param parameters
     */
    statusesDestroyById(parameters: StatusesDestroyByIdParams): Promise<StatusesDestroyById>;
    /**
     ...
     * @param parameters
     */
    statusesRetweetById(parameters: StatusesRetweetByIdParams): Promise<unknown>;
    /**
     ...
     * @param parameters
     */
    statusesUnretweetById(parameters: StatusesUnretweetByIdParams): Promise<StatusesUnretweetById>;
    /**
     ...
     */
    statusesUpdate(): Promise<unknown>;
}
